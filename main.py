...
def app_model(resumes, vacancies):
    ...
    emb_vacancy = model.encode(vacancies, convert_to_tensor=True)
...
resume = st.text_input("Резюме:")
vacancy = st.text_input("Описание вакансии:")

print(resume)


if st.button("Оценить"):
     score = app_model(resume, vacancy)
